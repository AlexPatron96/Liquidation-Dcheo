            ...
            <Row className="justify-content-md-center conte-box-sigin">
                <Col xs lg="6">
                    ...
                    <div className='box-public'>
                        ...
                        <img className='img-sigin-logo' src={logoempresanew} alt="" />
                    </div>
                </Col>
                ...
                <Col xs lg="4">
                    ...
                    <div className='box-sigin'>
                        ...
                        <Form onSubmit={handleSubmit(submit)}>
                            <Form.Group className="mb-3 form-cont" controlId="formBasicEmail">
                                <Form.Label>Correo Electronico</Form.Label>
                                <Form.Control className='input-sigin' type="email" placeholder="Email" {...register('mail')}
                                    style={{ borderColor: errUser ? "#FF5252" : null }} />
                                <Form.Text className="text-muted">
                                    {
                                        errUser ? <span style={{ fontSize: "13px", color: "#FFD8D8" }}>El correo no es valido</span>
                                            : null
                                    }
                                </Form.Text>
                            </Form.Group>

                            <Form.Group className="mb-3 form-cont" controlId="formBasicPassword">
                                <Form.Label>Contraseña</Form.Label>
                                <Form.Control className='input-sigin' type="password" placeholder="Password" {...register('password')}
                                    style={{ borderColor: errPassword || errUser ? "#FF5252" : null }} />
                                {
                                    errPassword ? <span style={{ fontSize: "13px", color: "#FFD8D8" }}>La contrasena no es valida para el Usuario</span>
                                        : null
                                }
                            </Form.Group>
                    ...
                    <div>
                        ...
                        <p className='developer'>
                            LiquidationAPP - Copyright © 2023 BossDesign. Todos los derechos reservados.
                        </p>
