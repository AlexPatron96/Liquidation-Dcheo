                    ...
                    {data?.map((item, index) => (
                        <tr key={index} style={{ height: "50px" }}>
                            ...
                            {editingIndex === index ?
                                ...
                                :
                                (<td style={{ width: "200px", fontSize: "13px"  }}>
                            ...
                            {editingIndex === index ?
                                ...
                                :
                                (<td style={{ width: "300px", fontSize: "13px" }}>
                            ...
                            {editingIndex === index ?
                                (<td>
                                    <select name="id_seller"
                                        ...
                                        style={{ padding: "3px", paddingRight: "40px", width: "150px", fontSize: "14px" }}
                                        value={editedData.id_seller}
                                        onChange={handleInputChange}       >
                                        <option>Seleccione Vendedor</option>
                                        {
                                            seller.map((sell, index) => (
                                                <option key={index} value={sell?.id}>{sell?.id} - {sell?.name}</option>
                            ...
                            {editingIndex === index ?
                                (<td>
                                    <select name="id_route_day"
                                        className="form-select h-25"
                                        style={{ padding: "3px", paddingRight: "40px", width: "125px", fontSize: "13px" }}
                                        value={editedData.id_route_day}
                                        onChange={handleInputChange}       >
                                        <option >Seleccione Ruta</option>
                                        {
                                            routeDay.map((rout, index) => (
                                                <option key={index} value={rout?.id}>{rout.id_route_route?.name} - {rout?.day.day} </option>
                                            ))
                                        }
                                    </select>
                                ...
                                :
                                (<td style={{ width: "135px", fontSize: "12px" }}>
                                    {item.route_day?.id_route_route.name} - {item.route_day?.day.day}
                                </td>)
                            }
