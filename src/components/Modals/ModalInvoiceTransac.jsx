        ...
        <div>
            <Modal show={show} onHide={onhide} centered size="lg"
                ...
                <Modal.Body>
                    ...
                    <Form className='formModal' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control disabled={editValue} style={{ width: "70px" }}  {...register('id_bill', { required: true })} />
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control disabled={editValue} style={{ width: "190px" }} {...register('num_bill', { required: true })} />
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control disabled={editValue} type="date" {...register("balance_date", { required: true })} />
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control disabled={editValue} style={{ width: "150px" }} {...register("id_user", { required: true })}
                            />
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control placeholder='Ingrese informacion sobre el pago.' style={{ width: "700px" }} {...register("detail", { required: false })}
                            />
                        </Form.Group>
                ...
                <Modal.Footer>
                    ...
                    <Buttonatom created={EditTransaction}
                        title={"Editar"} color={"primary"} ico={"fa-pen-to-square"} />

                    <Buttonatom created={onhide}
                        title={"Cerrar"} color={"warning"} ico={"fa-door-closed"} />

                    <Buttonatom created={handleSubmit(onSubmit)}
                        title={"Pagar"} color={"success"} ico={"fa-dollar-sign"} />
                </Modal.Footer>
            </Modal>
        </div>
    );
