        ...
        <div>
            <Modal show={show} onHide={onhide} centered size="lg"
                ...
                <Modal.Body>
                    ...
                    <Form className='formModal' onSubmit={handleSubmit(onSubmitFilter)}>

                        {/* Id CLiente */}
                        <Form.Group className="mb-3">
                            <Form.Label>Cliente</Form.Label>
                            <input name="id_client" className="form-control"
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control style={{ width: "190px" }} {...register('num_bill')} />
                        </Form.Group>
                        ...
                        <div>
                            ...
                            <div style={{ display: "flex", flexDirection: "row", gap: "1rem" }}>
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control type="date" {...register("date_init")} />
                                    <p className={`error-message ${errors["date_init"] ? 'showError' : ''}`}>Campo requerido</p>
                                </Form.Group>
                                {/* Fecha final*/}
                                <Form.Group className="mb-3">
                                    <Form.Label>Fecha Final</Form.Label>
                                    <Form.Control type="date" {...register("date_end")} />
                                    <p className={`error-message ${errors["date_end"] ? 'showError' : ''}`}>Campo requerido</p>
                                </Form.Group>
                            </div>
                        </div>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Select  {...register(`id_seller`)}
                                style={{ fontSize: "14px" }}
                            >
                ...
                <Modal.Footer>
                    ...
                    <Buttonatom created={() => { reset(); setSearchCustomer('') }}
                        title={"Limpiar"} color={"secundary"} ico={"fa-brush"} />

                    <Buttonatom created={onhide}
                        title={"Cerrar"} color={"warning"} ico={"fa-door-closed"} />

                    <Buttonatom created={handleSubmit(onSubmitFilter)}
                        title={"Buscar"} color={"success"} ico={"fa-filter"} />
                </Modal.Footer>
            </Modal>
        </div>
    );
