            ...
            >
                ...
                <Modal.Body>
                    <div>
                        <div>
                            <h4>Crear Ruta</h4>
                            <Form className='formModal' onSubmit={handleSubmit(onSubmitRoute)} style={{ alignItems: "center" }}>

                                <Form.Group className="mb-3">
                                    <Form.Label style={{ fontSize: "14px" }}>Nombre</Form.Label>
                                    <Form.Control
                                        style={{ fontSize: "14px", padding: "0.5rem" }}
                                        placeholder="Nombre de la ruta"
                                        onChange={(e) => e.target.value = e.target.value.toUpperCase()}
                                        {...register(`name`, { required: true })} />
                                    <p className={`error-message ${errors["name"] ? 'showError' : ''}`}>Este campo es requerido</p>
                                </Form.Group>

                                <Form.Group className="mb-3">
                                    <Form.Label style={{ fontSize: "14px" }}>Codigo MV</Form.Label>
                                    <Form.Control
                                        style={{ fontSize: "14px", padding: "0.5rem" }}
                                        placeholder="Codigo MobilVendor"
                                        onChange={(e) => e.target.value = e.target.value.toUpperCase()}
                                        {...register(`external_code`, { required: true })} />
                                    <p className={`error-message ${errors["external_code"] ? 'showError' : ''}`}>Este campo es requerido</p>

                                </Form.Group>

                                <Form.Group className="mb-3">
                                    <Form.Label style={{ fontSize: "14px" }}>Detalle adicional</Form.Label>
                                    <Form.Control
                                        style={{ fontSize: "14px", padding: "0.5rem" }}
                                        placeholder="Detalle relevante"
                                        {...register(`detail`, { required: true })} />
                                    <p className={`error-message ${errors["detail"] ? 'showError' : ''}`}>En caso de no tener un detalle adicional coloque " ok "</p>
                                </Form.Group>

                                <Button variant="success" type="submit" style={{ height: "50px" }} onClick={handleSubmit(onSubmitRoute)}>
                                    Guardar
                                </Button>
                            </Form>
                        </div>
                        ...
                        <div className='tables-view'>
                            <Table striped bordered hover responsive style={{ width: "740px" }}>
                                <thead >
                                    <tr>
                                        ...
                                        <th style={{ width: "175px" }}>Detalle Ad</th>
                                        ...
                                        route.map((rou, index) => (
                                            <tr key={index}>
                                                ...
                                                {editingIndex === index ?
                                                    ...
                                                    :
                                                    (<td style={{ width: "120px" }}>{rou.name}</td>)
                                                }
                                                ...
                                                {editingIndex === index ?
                                                    (<td style={{ textAlign: "center" }}>
                                                        <input
                                                            ...
                                                            name='external_code'
                                                            onChange={handleInputChange}
                                                            value={editedData.external_code}
                                                        />
                                                    </td>)
                                                    :
                                                    (<td style={{ width: "70px" }}>{rou.external_code}</td>)
                                                }
                                                ...
                                                {editingIndex === index ?
                                                    ...
                                                    :
                                                    (<td style={{ width: "175px" }}>{rou.detail}</td>)
                                                }
