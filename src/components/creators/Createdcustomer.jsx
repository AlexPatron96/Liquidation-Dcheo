...
const Createdcustomer = (props) => {
    ...
    const listShow = ["Nombre", "Codigo MV", "Direccion", "Identificacion", "Vendedor", "Dia de Venta",];
                ...
                <Modal.Body>
                    ...
                    <Form className='formModal' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control  {...register(`${listDB[2]}`, { required: true })}

                            />
                            <p className={`error-message ${errors[listDB[2]] ? 'showError' : ''}`}>Este campo es requerido</p>
                        </Form.Group>
                            ...
                            <div>
                                ...
                                <div style={{ display: "flex", flexDirection: "row" }}>
                                    ...
                                    <Form.Control
                                        ...
                                        {...register(`${listDB[3]}`, {
                                            required: true,
                                            minLength: selectedOption === "Cédula" ? 10 : 13,
                                            maxLength: selectedOption === "RUC" ? 13 : 10,
                                        })}
                                        inputMode="numeric"
                                    />
                                </div>
                                <p className={`error-message ${errors[listDB[3]] ? 'showError' : ''}`}>
                                    {`${(errors[listDB[3]]?.type) === 'minLength' ? "Alert! Hay menos digitos" : ""}`}
                                    {`${(errors[listDB[3]]?.type) === "maxLength" ? "Alert! Hay mas digitos" : ""}`}
                                </p>
                            </div>
                        </Form.Group>
